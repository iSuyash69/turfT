...
const Card=({card})=>{
    ...
    return(
        <div onClick={()=>{router.push(`/turf/${card?._id}`)}} className="mt-7 relative max-h-[290px] max-w-[320px] min-h-[290px] min-w-[320px] cursor-pointer bg-gray-200 mb-5 overflow-hidden rounded-3xl shadow-gray-400 shadow-lg ">
